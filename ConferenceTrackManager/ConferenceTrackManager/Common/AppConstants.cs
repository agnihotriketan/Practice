namespace ConferenceManager.AppConstants
{
    public static class AppConstants
    {
        ...
        public static string InputFilePath { get; } = "D:/MyGit/Practice/ConferenceTrackManager/ConferenceTrackManager/Input/input.txt";
        ...
        public static string appExit { get; } = "Press any key to exit";
